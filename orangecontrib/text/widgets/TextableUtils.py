...
class InfoBox(object):
    ...
    def __init__(
            self,
            widget,
            stringDataSent=u'数据已经正确输出',
            stringNoDataSent=u'没有输出数据',
            stringSettingsChanged=u'设置已改变',
            stringInputChanged=u'输入已改变',
            stringSeeWidgetState=u", 详见下面 'Widget state'.",
            stringClickSend=u", 请点击 '发送'.",
            wrappedWidth=30,
    ):
